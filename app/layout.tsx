  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        ...
        <div
          id="theme-segment"
          className="fixed top-4 right-4 z-50 flex items-center gap-1 rounded-xl border border-[--border]/60 bg-background/70 backdrop-blur p-1"
          role="group"
          aria-label="Theme selection"
        >
          <button
            data-theme="dark"
            className="flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm hover:bg-[--foreground]/10"
            type="button"
            aria-pressed="false"
            title="Dark"
          >
